# filepath: tools/frontier_prototype/shim_core.py
# VERBATIM COPY of wp-d-planner@11f7339:src/planner_shim/planner_shim/shim_core.py
# for the prototype only. Product code must import planner_shim.shim_core instead.
